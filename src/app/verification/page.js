          ...
          <>
            ...
            <div className="flex justify-start mb-4">
              <button
                ...
                className="bg-[#3B3836] px-4 py-2 rounded-md hover:bg-[#4e4c4b] mr-2"
              >
                Resend Code
              </button>
            </div>
        ...
        return (
          <>
            ...
            <div className="text-center mt-2">
              <a href="#" className="text-[#8281db] text-sm hover:underline">
      ...
      case 4:
        return (
          <>
            ...
            <p className="mb-4">
              Your information has been successfully verified your account has been secured. Please{" "}
  ...
  return (
    ...
    >
      ...
      <div className="flex-grow flex items-center justify-center gap-4 p-4">
        <div className="bg-white w-full md:w-md max-w-lg p-6 rounded-lg shadow-xl">
          {/* Logo */}
