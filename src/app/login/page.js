...
import Moose from "/public/assets/moose.jpg"
import Image from 'next/image';
import Footer from '../components/Footer';
import Logo from "/public/assets/logo.png"

export default function BangorLogin() {
          ...
          <div className="w-full lg:w-1/2 relative">
            {infoTab === 'moose' ? (
              ...
              <div className="bg-black text-white p-6 h-full">
                ...
                <p>
                  Bangor Support can be reached by phone at 1.877.226.4671 or by chat on bangor.com. We are available Monday - Friday 7:00 AM - 7:00 PM, Saturday 8:00 AM - 2:00 PM & Sunday 9:00 AM - 2:00 PM.
                </p>
              </div>
            )}
            {infoTab === 'moose' && (
          ...
          <div className=" lg:w-1/2 p-4 lg:p-8 self-center lg:self-start">
            ...
            <div>
              ...
              <button
                ...
                className={`w-full bg-[#8281db] text-white py-3 rounded mb-4 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
